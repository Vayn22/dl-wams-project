...
import { Brain, CalendarDays, LayoutDashboard, LogOut, Plus, UserCircle, Users } from "lucide-react";
...
const navItems = [
  ...
  { href: "/doctor/appointments", label: "Rendez-vous", icon: CalendarDays },
  { href: "/doctor/models", label: "Modeles IA", icon: Brain },
  { href: "/doctor/account", label: "Mon compte", icon: UserCircle },
];
  ...
  return (
    <aside className="fixed left-0 top-0 flex min-h-screen w-64 flex-col bg-[#1E3A5F] text-white">
      ...
      <div className="px-6 pb-5">
        ...
        <Badge className={cn("mt-2", SPECIALTY_BADGE[currentUser?.specialty])}>
